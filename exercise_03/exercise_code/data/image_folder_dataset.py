...
class ImageFolderDataset(Dataset):
    ...
    def __len__(self):
        ...
        # I assume finding length of label list is faster than for image list
    ...
    def __getitem__(self, index):
        ...
        # self.labels is already a list if integers, no need for conversion
        # print(type(self.labels[index]))

        # self.images is a path, not the actual image file itself
        # Only apply self.transform if Transform class was passed
        # as argument during init
